...
Display overlay area on top of a page, represents a modal or non-modal dialog box.<br/> Build on top of the native HTML [`<dialog/>`](https://developer.mozilla.org/docs/Web/HTML/Reference/Elements/dialog) element.
...
<Tabs>
  <TabItem label="Playground">
    <Demo path="dialog/base" client:load />
  </TabItem>
  <TabItem label="Source code">
    <Code
      title="base.tsx"
      lang="tsx"
      code={`import {DialogBase} from '@kaiverse/k/ui'\n
  function BaseDialog() {
    ...
    return (
      <>
        ...
        <DialogBase open={openDialog} onClose={() => setOpenDialog(false)}>
          <DialogBase.Header>
...
<Tabs>
  ...
  <TabItem label="Source code">
    <Code
      title="basic.tsx"
      lang="tsx"
      code={`import {Dialog} from '@kaiverse/k/ui'\n
...
you can close that `<Dialog>` by using [form method](https://developer.mozilla.org/docs/Web/HTML/Reference/Elements/form#method) `method="dialog"`
...
<Aside type="tip">
  These compound components are opt-in, you can use your own.
</Aside>
...
`Dialog` component build on top of the HTML [`<dialog/>`](https://developer.mozilla.org/docs/Web/HTML/Reference/Elements/dialog) element.
