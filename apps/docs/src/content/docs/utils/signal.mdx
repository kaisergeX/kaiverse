...
This package is built for vanilla JS/TS applications. However, there are implementations to adapt with some frameworks's reactive systems.
...
Docs: <a href={`${import.meta.env.BASE_URL}/hooks/signal`}>`Hooks/signal`</a>
